SUBROUTINE SIMPLE2_HL2FL ( KIDIA, KFDIA, KLON, KTDIAT, KLEV, PAPRS, PAPRSF, PXHL, &
& KINI, PXFL, CDLOCK) 
!
...
REAL(KIND=JPRB)   ,INTENT(IN)    :: PXHL(KIDIA:KFDIA,KINI:KLEV)
