...
WRITE (0, *) __FILE__, ':', __LINE__, ' ', LLSET
...
#define DIFFD(x) CALL DDIFF (#x, x##_ALL)
...
DO JLON = IFDIA (IBL)+1, KLON
  DO J2 = LBOUND (PALL, 2), UBOUND (PALL, 2)
    V = PALL (IFDIA (IBL),J2,IBL)
    PALL (JLON,J2,IBL) = V
  ENDDO
ENDDO
