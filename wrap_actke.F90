...
KSIZST = KLON * (21 * KLEV + 11)

KPTRST = 1
ALLOCATE (PSTACK_ALL (KSIZST, ICOUNT))
...
!$acc enter data create (PSTACK_ALL)
...
!$acc parallel loop gang vector private (IBLOCK) private (JIDIA, JFDIA, JJ) collapse (2)
...
DO IBLOCK = 1, ICOUNT1
  ...
  DO JJ = 1, KLON
    ...
    & UDECT, UPRETMAX, UPRETMIN, USHEARM, USURIC, VKARMN, KSIZST, KPTRST, PSTACK_ALL (:, IBLOCK))
...
!$acc exit data delete (PSTACK_ALL)
