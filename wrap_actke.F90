...
#ifdef GPU
CALL RUN_SIMPLE4_ACTKE <<<KLON1/NPROMA, NPROMA>>> &
#else
CALL RUN_SIMPLE4_ACTKE &
#endif
&                      (NPROMA, KIDIA_ALL, KFDIA_ALL, KLON_ALL, KTDIAT_ALL, KTDIAN_ALL, KLEV_ALL,     &
& PAPHI_ALL (:,:,1), PAPHIF_ALL (:,:,1), PAPRS_ALL (:,:,1), PAPRSF_ALL (:,:,1), PDELP_ALL (:,:,1),    &
& PR_ALL (:,:,1), PT_ALL (:,:,1), PU_ALL (:,:,1), PV_ALL (:,:,1), PQ_ALL (:,:,1), PLSCPE_ALL (:,:,1), &
& PCD_ALL (:,1), PCH_ALL (:,1), PGZ0_ALL (:,1), PTS_ALL (:,1), PQS_ALL (:,1), PQICE_ALL (:,:,1),      &
& PQLI_ALL (:,:,1), PECT_ALL (:,:,1), PPRODTH_ALL (:,:,1), PNLAB_ALL (:,:,1), PNLABCVP_ALL (:,:,1),   &
& PKTROV_ALL (:,:,1), PKUROV_ALL (:,:,1), PXTROV_ALL (:,:,1), PXUROV_ALL (:,:,1), PNBVNO_ALL (:,:,1), &
& PNEBS_ALL (:,:,1), PQCS_ALL (:,:,1), PNEBS0_ALL (:,:,1), PQCS0_ALL (:,:,1), PCOEFN_ALL (:,:,1),     &
& PFECT_ALL (:,:,1), PECT1_ALL (:,:,1),  PTPRDY_ALL (:,:,1), PEDR_ALL (:,:,1),                        &
& RG_ALL, RPRTH_ALL, ECTMIN_ALL, TSPHY_ALL, ACBRPHIM_ALL, ADISE_ALL,                                  &
