...
SUBROUTINE DIFFX1 (CDNAME, X1, X1_1, KLON1, KLON2, KLONS)
CHARACTER (LEN=*) :: CDNAME
REAL (KIND=JPRB) :: X1 (:), X1_1 (:) 
INTEGER :: I1
INTEGER :: KLON1, KLON2, KLONS
DO I1 = MAX (KLON1, 1), MIN (KLON2, SIZE (X1)), KLONS
...
SUBROUTINE DIFFX2 (CDNAME, X2, X2_1, KLON1, KLON2, KLONS)
CHARACTER (LEN=*) :: CDNAME
REAL (KIND=JPRB) :: X2 (:,:), X2_1 (:,:)
INTEGER :: KLON1, KLON2, KLONS
INTEGER :: I1, I2
DO I1 = MAX (KLON1, 1), MIN (KLON2, SIZE (X2, 1)), KLONS
DO I2 = 1, SIZE (X2, 2)
