...
REAL (KIND=JPRB) :: ZUSLE (KLON,KLEV)
REAL (KIND=JPRB) :: ZLMECT (KLON,KLEV)
REAL (KIND=JPRB) :: ZPHI3 (KLON,KLEV)
REAL (KIND=JPRB) :: ZPRODTH (KLON,KLEV)
REAL (KIND=JPRB) :: ZPRDY (KLON,KLEV)
REAL (KIND=JPRB) :: ZDIFF (KLON,KLEV)
REAL (KIND=JPRB) :: ZDISS (KLON,KLEV)
REAL (KIND=JPRB) :: ZECT (KLON,KLEV)
REAL (KIND=JPRB) :: ZECT1 (KLON,KLEV)
REAL (KIND=JPRB) :: ZDELPSG (KLON,KLEV)
REAL (KIND=JPRB) :: ZDET (KLON,KLEV)
REAL (KIND=JPRB) :: ZKCLS (KLON)
REAL (KIND=JPRB) :: ZECTCLS (KLON)
...
CALL SIMPLE4_FL2HL ( KIDIA, KFDIA, KLON, 1, KLEV, PAPRS, PAPRSF, PECT, ZECT, 1, &
& 'FL2HL  ')
...
& PTPRDY, 'HL2FL  ', KPSTSZ, IPTRST, PSTACK) 
! EDR
CALL SIMPLE4_HL2FL ( KIDIA, KFDIA, KLON, 1, KLEV,  PAPRS, PAPRSF, ZEDR, 1, PEDR, &
& 'HL2FL  ', KPSTSZ, IPTRST, PSTACK) 
