...
REAL (KIND=JPRB) :: ZSTAB (KLON)
REAL (KIND=JPRB) :: ZRS (KLON)
REAL (KIND=JPRB) :: ZRTV (KLON,KLEV)
REAL (KIND=JPRB) :: ZGDZF (KLON,KLEV)
REAL (KIND=JPRB) :: ZZ (KLON,KLEV)
REAL (KIND=JPRB) :: ZTHETA (KLON,KLEV)
REAL (KIND=JPRB) :: ZTHETALF (KLON,KLEV)
REAL (KIND=JPRB) :: ZLOCPEXF (KLON,KLEV)
REAL (KIND=JPRB) :: ZTHETAVL (KLON,KLEV)
REAL (KIND=JPRB) :: ZGKTH (KLON,0:KLEV)
REAL (KIND=JPRB) :: ZGKUH (KLON,0:KLEV)
...
!         - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    ZSRC   = (1.0_JPRB-ZINC)*YT_TAB%ZSRC1D(INQ1)+ZINC*YT_TAB%ZSRC1D(INQ1+1)
