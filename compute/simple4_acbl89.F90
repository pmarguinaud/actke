...
REAL (KIND=JPRB) :: ZGDZF     (KLON,KLEV)
REAL (KIND=JPRB) :: ZGDZH     (KLON,KLEV)
REAL (KIND=JPRB) :: ZTHETAH   (KLON,0:KLEV)
REAL (KIND=JPRB) :: ZTHETA    (KLON,KLEV)
REAL (KIND=JPRB) :: ZDTHETA   (KLON,KLEV)
REAL (KIND=JPRB) :: ZTHETAP   (KLON,KLEV)
REAL (KIND=JPRB) :: ZEN       (KLON)
REAL (KIND=JPRB) :: ZGZBOT    (KLON)
REAL (KIND=JPRB) :: ZGZTOP    (KLON)
REAL (KIND=JPRB) :: ZGZBOTCVP (KLON)
REAL (KIND=JPRB) :: ZGZTOPCVP (KLON)
REAL (KIND=JPRB) :: ZGLMUP    (KLON,KLEV)
REAL (KIND=JPRB) :: ZGLMDN    (KLON,KLEV)
REAL (KIND=JPRB) :: ZPHIH     (KLON,KLEV)
REAL (KIND=JPRB) :: ZLUP      (KLON)
REAL (KIND=JPRB) :: ZLWK1     (KLON)
