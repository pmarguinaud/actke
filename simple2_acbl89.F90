...
REAL(KIND=JPRB) :: ZGDZF   (KIDIA:KFDIA,KLEV),ZGDZH  (KIDIA:KFDIA,KLEV)
REAL(KIND=JPRB) :: ZTHETAH (KIDIA:KFDIA,0:KLEV),ZTHETA (KIDIA:KFDIA,KLEV),ZDTHETA (KIDIA:KFDIA,KLEV)
REAL(KIND=JPRB) :: ZTHETAP (KIDIA:KFDIA,KLEV)

REAL(KIND=JPRB) :: ZEN(KIDIA:KFDIA),ZGZBOT(KIDIA:KFDIA),ZGZTOP(KIDIA:KFDIA),ZGZBOTCVP(KIDIA:KFDIA),ZGZTOPCVP(KIDIA:KFDIA)
REAL(KIND=JPRB) :: ZGLMUP (KIDIA:KFDIA,KLEV),ZGLMDN (KIDIA:KFDIA,KLEV),ZPHIH(KIDIA:KFDIA,KLEV)
...
REAL(KIND=JPRB) ::  ZDLDN,  ZDLDN1,  ZDLDN2,   ZQV, &
 ...
 & Z2SQRT2, ZLUP(KIDIA:KFDIA), ZLDN,ZLWK0,ZLWK1(KIDIA:KFDIA)
...
DO JLON = KIDIA, KFDIA
  ZGZTOP(JLON) = 0.0_JPRB
ENDDO
DO JLON = KIDIA, KFDIA
  ZGZBOT(JLON) = 100000.0_JPRB
ENDDO

DO JLON = KIDIA, KFDIA
  ZGZTOPCVP(JLON) = 0.0_JPRB
ENDDO
DO JLON = KIDIA, KFDIA
  ZGZBOTCVP(JLON) = 100000.0_JPRB
ENDDO
