...
FC = ifort $(FRTFLAGS) $(OPT_FRTFLAGS) -DCPU 
...
wrap_actke.x: wrap_actke.o run_simple4_actke.o simple4_acbl89.o  simple4_acevolet.o  simple4_actke.o  simple4_acturb.o  simple4_fl2hl.o  simple4_hl2fl.o parkind1.o load_mod.o yomlog.o xrd_unix_env.o xrd_getoptions.o linux_bind.o
	$(FC) -o wrap_actke.x wrap_actke.o run_simple4_actke.o simple4_acbl89.o  simple4_acevolet.o  simple4_actke.o  simple4_acturb.o  simple4_fl2hl.o  simple4_hl2fl.o parkind1.o load_mod.o yomlog.o xrd_unix_env.o xrd_getoptions.o linux_bind.o
...
linux_bind.o: linux_bind.c
	icc -qopenmp -DLINUX -g -c linux_bind.c
