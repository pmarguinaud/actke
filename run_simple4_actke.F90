...
INTEGER :: IIDIA, IFDIA, II

#ifdef GPU

  IIDIA  = (BLOCKIDX%X-1) * NPROMA + THREADIDX%X
  IFDIA  = (BLOCKIDX%X-1) * NPROMA + THREADIDX%X

#else

!$OMP PARALLEL DO PRIVATE (II, IIDIA, IFDIA)
...
! PRINT *, OMP_GET_THREAD_NUM (), " IIDIA = ", IIDIA, " IFDIA = ", IFDIA

#endif


  CALL SIMPLE4_ACTKE (IIDIA, IFDIA, KLON, KTDIAT, KTDIAN, KLEV, PAPHI,         &
  & PAPHIF, PAPRS, PAPRSF, PDELP, PR, PT, PU, PV, PQ, PLSCPE, PCD, PCH, PGZ0,  &
  & PTS, PQS, PQICE, PQLI, PECT, PPRODTH, PNLAB, PNLABCVP, PKTROV, PKUROV,     & 
  & PXTROV, PXUROV, PNBVNO, PNEBS, PQCS, PNEBS0, PQCS0, PCOEFN, PFECT, PECT1,  &
  & PTPRDY, PEDR, RG, RPRTH, ECTMIN, TSPHY, ACBRPHIM,                          &
