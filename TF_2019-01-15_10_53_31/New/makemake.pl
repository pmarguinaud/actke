...
#
print MAKEFILE "LIBS =\t\n\n";
print MAKEFILE "CC = pgcc\n";
print MAKEFILE "CFLAGS = -fast\n";
print MAKEFILE "FC = pgfortran\n";
print MAKEFILE "FFLAGS = -fast\n";
print MAKEFILE "F90 = pgf90\n";
print MAKEFILE "F90FLAGS = -fast\n";
...
#
print MAKEFILE ".F90.o:\n";
print MAKEFILE "\t\$(F90) -Mpreprocess \$(F90FLAGS) -c \$<\n\n";
#
# Dependency listings
#
