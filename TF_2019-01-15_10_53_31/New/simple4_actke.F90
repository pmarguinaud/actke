...
#ifdef NVTX
SUBROUTINE SIMPLE4_ACTKE ( BLOCK_NUM,KIDIA, KFDIA, KLON, KTDIAT, KTDIAN, KLEV, PAPHI,      &
#else
...
#ifdef NVTX
INTEGER(KIND=JPIM),INTENT(IN)    :: BLOCK_NUM
CHARACTER(LEN=4) :: BLOCK_COUNT
#endif
...
INTEGER (KIND=JPIM) :: IPTRST_ZDIFF

INTEGER (KIND=JPIM) :: IPTRST_ZPRDY
...
#ifdef D_LAST_LEVEL
#ifdef NVTX
WRITE(BLOCK_COUNT,'(I4)') BLOCK_NUM
#endif
#endif
...
DO_JLON
  PSTACK(JLON,IPTRST_ZDET+1-1:IPTRST_ZDET+KLEV-1)=0.0_JPRB
ENDDO_JLON
DO_JLON
...
#ifdef D_LAST_LEVEL
#ifdef NVTX
call nvtxStartRange("SIMPLE4_FL2HL"//BLOCK_COUNT,BLOCK_NUM)
#endif
#endif
...
#ifdef DEBUG_FC
print *,'Dans simple4_actke SIMPLE4_FL2HL done'
#endif
...
#ifdef D_LAST_LEVEL
#ifdef NVTX
call nvtxStartRange("SIMPLE4_ACBL89"//BLOCK_COUNT,BLOCK_NUM)
#endif
#endif
...
#ifdef DEBUG_FC
print *,'Dans simple4_actke SIMPLE4_ACBL89 done'
#endif


#ifdef D_LAST_LEVEL
#ifdef NVTX
call nvtxStartRange("SIMPLE4_ACTURB"//BLOCK_COUNT,BLOCK_NUM)
#endif
#endif
...
#ifdef DEBUG_FC
print *,'Dans simple4_actke SIMPLE4_ACTURB done'
#endif
...
#ifdef D_LAST_LEVEL
#ifdef NVTX
call nvtxStartRange("SIMPLE4_ACEVOLET"//BLOCK_COUNT,BLOCK_NUM)
#endif
#endif
...
& IPTRST_ZECTCLS), PSTACK(1,IPTRST_ZECT1), PSTACK(1,IPTRST_ZPRDY), PSTACK(1,      &
& IPTRST_ZDIFF), PSTACK(1,IPTRST_ZDISS), RG, ECTMIN, ADISE, ALPHAE, ADISI,        &
...
#ifdef D_LAST_LEVEL
#ifdef NVTX
call nvtxStartRange("SIMPLE4_HL2FL 1"//BLOCK_COUNT,BLOCK_NUM)
#endif
#endif
...
DO JLEV = KTDIAT, KLEV
   DO_JLON
      PSTACK(JLON,IPTRST_ZDET+JLEV-1)=(PECT1(JLON,JLEV)-PECT(JLON,JLEV))/TSPHY
   ENDDO_JLON
ENDDO
#ifdef D_LAST_LEVEL
!$acc end kernels
...
#ifdef D_LAST_LEVEL
#ifdef NVTX
call nvtxStartRange("SIMPLE4_HL2FL 2"//BLOCK_COUNT,BLOCK_NUM)
#endif
#endif

CALL SIMPLE4_HL2FL ( KIDIA, KFDIA, KLON, 1, KLEV,  PAPRS, PAPRSF, PSTACK(1, &
& IPTRST_ZPRDY), 1, PTPRDY, KSIZST, IPTRST, PSTACK) 
...
#ifdef D_LAST_LEVEL
#ifdef NVTX
call nvtxStartRange("SIMPLE4_HL2FL 3"//BLOCK_COUNT,BLOCK_NUM)
#endif
#endif
...
DO JLEV = KTDIAT, KLEV
   DO_JLON
      PFECT(JLON,JLEV)=PFECT(JLON,JLEV-1)- PSTACK(JLON,IPTRST_ZDET+JLEV-1) &
