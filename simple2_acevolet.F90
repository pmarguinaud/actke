...
REAL(KIND=JPRB)   ,INTENT(IN)    :: PUSLE(KIDIA:KFDIA,KLEV) 
REAL(KIND=JPRB)   ,INTENT(INOUT)    :: PPRODTH(KIDIA:KFDIA,KLEV) 
REAL(KIND=JPRB)   ,INTENT(IN)    :: PKCLS(KIDIA:KFDIA) 
REAL(KIND=JPRB)   ,INTENT(IN)    :: PECTCLS(KIDIA:KFDIA) 
REAL(KIND=JPRB)   ,INTENT(IN)    :: PECT(KIDIA:KFDIA,KLEV) 
REAL(KIND=JPRB)   ,INTENT(OUT)   :: PECT1(KIDIA:KFDIA,KLEV) 
REAL(KIND=JPRB)   ,INTENT(OUT)   :: PPRDY(KIDIA:KFDIA,KLEV) 
REAL(KIND=JPRB)   ,INTENT(OUT)   :: PDIFF(KIDIA:KFDIA,KLEV) 
REAL(KIND=JPRB)   ,INTENT(OUT)   :: PDISS(KIDIA:KFDIA,KLEV)
...
REAL(KIND=JPRB) ::ZANKP1(KIDIA:KFDIA)

REAL(KIND=JPRB) :: ZA(KIDIA:KFDIA,KLEV),ZE(KIDIA:KFDIA,KLEV),ZPA(KIDIA:KFDIA,KLEV)&
 & ,ZGKU(KIDIA:KFDIA,0:KLEV),ZDET (KIDIA:KFDIA,KLEV)&
 & ,ZGKEF (KIDIA:KFDIA,KLEV),ZCOR(KIDIA:KFDIA)
